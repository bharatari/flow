module Data {
    ...
    export function checkCollision(circle1: View.Circle, circle2: View.Circle) {
        if(circle1 == circle2) {
            return false;
        }
    ...
    export function inertia(circle: View.Circle) {
    ...
    export function reverse(circle, height, width) {
    ...
    export function collide(circle1: View.Circle, circle2: View.Circle) {
    ...
    export function resetCollisions(circles) {
        for(var i = 0; i < circles.length; i++) {
            circles[i].collided = false;
        }
    }
    export function radiusIncrease(circle: View.Circle, mouse: View.Circle) {
    ...
    export function radiusReset(circle: View.Circle) {
