...
(function (View) {
    ...
    function setupView(circleCount, inertia, maxradius, maxvelocity, width, height) {
    ...
    function updateStage(event) {
        for (var i = 0; i < View.circles.length; i++) {
            ...
            if (this.mouseX && this.mouseY) {
                var mouseCircle = new View.Circle(200, this.mouseX, this.mouseY);
    ...
    function checkCollisions() {
        ...
        Data.resetCollisions(View.circles);
    }
